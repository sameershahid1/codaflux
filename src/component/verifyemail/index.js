    ...
    return (
        <div className='flex flex-col items-center justify-center gap-4'>
            <div className='flex flex-col items-center justify-center gap-5 mt-36' >
                ...
                <p className='text-gray-500 text-center max-w-[300px]'>Click the link we just send to your email <span className='font-medium text-gray-600'>demo123@gmail.com</span></p>
            </div>
            <div className='flex flex-col justify-center w-[350px] mt-4 gap-3' >
                ...
                <button onClick={handleForgotPassword} type='button' className='bg-[#314153] text-white h-12 rounded-lg font-semibold light-shadow-md'>New Password</button>
